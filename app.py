...
model = pickle.load(open('Assignment_5.pkl','rb'))   


def review(text1):
  dataset = pd.read_csv('NLP dataset 1.csv',  quoting=3)
...
st.header("Text predictions System ")
  
  
text1 = st.text_area("Writre the Text")
...
if st.button("About"):
  st.subheader("Developed by priyanshu rai")
  st.subheader("3rd Year Student , Department of Computer Engineering")
html_temp = """
